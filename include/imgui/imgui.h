...
namespace ImGui
{
    ...
    IMGUI_API ImGuiContext* Init(ImFontAtlas* shared_font_atlas = NULL);
    ...
    IMGUI_API void          Update();                                 // start a new Dear ImGui frame, you can submit any command from this point until Render()/EndFrame().
